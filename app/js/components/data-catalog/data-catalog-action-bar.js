...
import { documentAddIcon, searchIcon } from "../../icons.js";
...
const template = () => /* HTML */ `
  ...
  <div id="action-bar-container">
    ...
    <div id="actions-container">
      ...
      <cds-button id="add-data-button" kind="primary">
        Add data ${documentAddIcon({ width: 16, height: 16, slot: "icon" })}
      </cds-button>
    </div>
  </div>
`;
...
window.customElements.define(
  ...
  class extends asWebComponent(HTMLElement) {
    render() {
      ...
      this.addDataButton = this.shadow.querySelector("#add-data-button");
      this.debounceTimer;
      ...
      this.addDataButton.addEventListener("click", () => {
        this.dispatchEvent(new CustomEvent("add-data-button-click"));
      });
    }
  }
);
